...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nama = $_POST["nama"];
    $nip = $_POST["nip"]; // Ambil NIP dari permintaan POST
    ...
    // Simpan data lokasi, presensi, dan gambar wajah ke tabel presensi
    $sqlquery = "INSERT INTO presensi (nama, nip, latitude, longitude, wajah) VALUES ('$nama', '$nip', '$latitude', '$longitude', '$targetFile')";
